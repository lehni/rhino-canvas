...
/**
 * Name: InsertKeyAction<br>
 * Description: A class handling the insert key action (INSERT).
 * <br>Log: $Log: InsertKeyAction.java,v $
...
public class InsertKeyAction extends EditorAction {
   ...
   */
  public InsertKeyAction(TextArea textArea) {
    super(textArea);
  }
