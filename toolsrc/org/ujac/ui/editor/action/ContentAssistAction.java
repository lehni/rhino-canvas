...
/**
 * Name: ContentAssistAction<br>
 * Description: A class handling the content assist key action (CTRL+Space).
 * <br>Log: $Log: ContentAssistAction.java,v $
...
public class ContentAssistAction extends EditorAction {
   ...
   */
  public ContentAssistAction(TextArea textArea) {
    super(textArea);
  }
  ...
  public void actionPerformed(ActionEvent e) {
    textArea.getDocument().contentAssist(textArea);
  }
