...
/**
 * Name: InsertCharAction<br>
 * Description: A class handling the insert char action (any regular character).
 * <br>Log: $Log: InsertCharAction.java,v $
...
public class InsertCharAction extends EditorAction {
   ...
   */
  public InsertCharAction(TextArea textArea) {
    super(textArea);
  }
