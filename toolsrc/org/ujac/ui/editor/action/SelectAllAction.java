...
/**
 * Name: SelectAllAction<br>
 * Description: A class handling the select all action (CTRL+A).
 * <br>Log: $Log: SelectAllAction.java,v $
...
public class SelectAllAction extends EditorAction {
   ...
   * @param textArea The text area to perform actions on.
   */
  public SelectAllAction(TextArea textArea) {
    super(textArea);
  }
