...
/** 
 * Name: FindNextAction<br>
 * Description: Keyboard handler for 'find next' key.<br>
 * <br>Log: $Log: FindNextAction.java,v $
...
public class FindNextAction extends EditorAction {
   ...
   * @param textArea The text editor.
   */
  public FindNextAction(TextArea textArea) {
    super(textArea);
  }
