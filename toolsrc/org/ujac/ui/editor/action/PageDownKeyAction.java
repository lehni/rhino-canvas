...
/**
 * Name: PageDownKeyAction<br>
 * Description: A class handling the page down key action (PAGE_DOWN).
 * <br>Log: $Log: PageDownKeyAction.java,v $
...
public class PageDownKeyAction extends KeyAction {
   ...
   */
  public PageDownKeyAction(TextArea textArea) {
    super(textArea);
  }
