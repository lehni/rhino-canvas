...
/**
 * Name: DeleteKeyAction<br>
 * Description: A class handling the delete key action (DELETE).
 * <br>Log: $Log: DeleteKeyAction.java,v $
...
public class DeleteKeyAction extends KeyAction {
   ...
   */
  public DeleteKeyAction(TextArea textArea) {
    super(textArea);
  }
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    try {
      textArea.getDocument().remove(start, (caret + lineStart) - start, true);
