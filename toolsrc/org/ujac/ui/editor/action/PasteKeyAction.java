...
/**
 * Name: PasteKeyAction<br>
 * Description: A class handling the paste key action (CTRL+V).
 * <br>Log: $Log: PasteKeyAction.java,v $
 * <br>Log: Revision 1.1  2006/11/05 01:22:39  haustein
 * <br>Log: 0.20
 * <br>Log:
...
public class PasteKeyAction extends EditorAction {
   ...
   */
  public PasteKeyAction(TextArea textArea) {
    super(textArea);
  }
