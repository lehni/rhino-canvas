...
/**
 * Name: CaretPositionListener<br>
 * Description: The interface for caret position listeners.
 * <br>Log: $Log: CaretPositionListener.java,v $
...
public interface CaretPositionListener {
   ...
   * @param evt a CaretPositionEvent object
   */
